...
export default function Model({ ...props }: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh geometry={nodes.Cube_1.geometry} material={materials['マテリアル.002']} />
      <mesh geometry={nodes.Cube_2.geometry} material={materials['マテリアル.003']} />
      <mesh geometry={nodes.Cube001.geometry} material={nodes.Cube001.material} position={[0, -0.31, 0]} scale={1.24} />
      ...
      <mesh
        ...
        scale={[0.23, -0.6, 0.23]}
      />
      <mesh geometry={nodes.円.geometry} material={materials.マテリアル} position={[0, -1, 0]} scale={2.5} />
      <mesh
